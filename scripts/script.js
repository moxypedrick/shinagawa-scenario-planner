...
map.on('load', function() {
  ...
  map.addLayer({'id' : 'bmp',
   ...
   map.addSource('isochrone', {
    'type' : 'geojson',
    'data' : 'https://api.mapbox.com/isochrone/v1/mapbox/walking/-84.380378,33.767279?contours_minutes=5,7&contours_colors=6706ce,04e813&polygons=true&access_token=pk.eyJ1IjoibW94eXBlZCIsImEiOiJjaWgydGpwdmYweHJydnFtMzZzOXpmNjg3In0.5TXWYv0Z7nsOZHneIQOhxg' 
  })
...
map.on('mouseenter', 'bmp', function(e) {
// Change the cursor style as a UI indicator.
map.getCanvas().style.cursor = 'pointer';
 
var coordinates = e.features[0].geometry.coordinates.slice();
var description = e.features[0].bmp;
...
map.on('mouseleave', 'bmp', function() {
